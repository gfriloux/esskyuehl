/*
 * Copyright 2011, 2012, 2013, 2014 Mike Blumenkrantz <michael.blumenkrantz@gmail.com>
 *
...
void esql_fake_free(void *data EINA_UNUSED, Esql *e);
...
EAPI void     esql_fd_handler(Esql *e);
